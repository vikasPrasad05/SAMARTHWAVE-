...
// 🔥 Har service ke liye image URL add kar do apni choice ke according
const services = [
  {
    icon: <Sparkles />,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <Card
                className="relative p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 h-full overflow-hidden group"
                style={{
